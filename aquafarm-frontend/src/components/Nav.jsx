...
export default function Nav({ activeZone, onNavigate }) {
  ...
  React.useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const delta = 10; // Ignore tiny micro-scrolls to prevent jitter
  ...
  return (
    <header 
      ...
      style={{ top: 0, background: "rgba(10, 28, 51, 0.95)" }}
    >
      {/* Main Navbar */}
     <div className="flex items-center justify-between px-8 lg:px-14 h-28">
        <button
          onClick={() => {
            onNavigate("surface");
            setMobileMenuOpen(false);
...
<div className="hidden md:flex items-center ml-auto">
  ...
  {/* Contact */}
  <div className="flex items-center gap-8 ml-8 text-white whitespace-nowrap">
